...
function fetchAPOD(): string {
    ...
    try {
        ...
        return 'Erreur lors du chargement des données APOD: ' . $e->getMessage();
    }
}
...
function fetchIpInfoLocation(): string {
    ...
    try {
        ...
        return 'Erreur lors du chargement de la localisation par adresse IP: ' . $e->getMessage();
    }
}
...
function fetchGeoPluginLocationJson(): string {
    ...
    try {
        ...
        return 'Erreur lors du chargement de la localisation par adresse IP (JSON): ' . $e->getMessage();
    }
}
...
function fetchGeoPluginLocationXml(): string {
    ...
    try {
        ...
        return 'Erreur lors du chargement de la localisation par adresse IP (XML): ' . $e->getMessage();
    }
}
